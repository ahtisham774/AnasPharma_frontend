...
class Invoice extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className=" bg-white border rounded-lg border-subtle p-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            <div className="w-full flex flex-col">
              ...
              <div>
                ...
                Rs. {this.props.totalAmount.toFixed(2)}
                </h1>
              </div>
            </div>
          ...
          <div className="mt-4 flex justify-between">
            ...
            <div className="text-md font-bold">Rs. {(this.props.totalAmount).toFixed(2)}</div>
          </div>
          <div className="mt-4 flex justify-between">
            <div className="text-lg font-medium">Discount</div>
            <div className="text-md font-bold">{this.props.discount || 0}% </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-start w-48">
                    ...
                    <div className="flex flex-col text-bold text-lg uppercase whitespace-nowrap ml-2">
                      {item.productName}
                    </div>
                  </div>
                  <div className="flex w-20">{item.quantity}</div>
                  <h1 className="w-20 text-lg text-black font-medium antialiased whitespace-nowrap text-left">
