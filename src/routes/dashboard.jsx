...
class Dashboard extends React.Component {
  ...
  render() {
    ...
    const lowStock = this.props.data.lowStocks
    const outOfStock = this.props.data.outOfStocks
    ...
    return (
      <div>
        ...
        <div className="flex h-9/10">
          ...
          <div className=" mt-auto xl:w-10/12 w-full p-4 pb-20 xl:pb-0 lg:p-10 bg-gray-50 xl:ml-auto">
            <TopBanner />
            {/* middle section */}
...
const mapDispatchToProps = (dispatch) => {
  return {
    loadData: () => dispatch(HomeActions.read()),
  };
};
